...
Click one of these hosting links ([Host 1](https://share.streamlit.io/wjiang/ctfsimulation) | [Host 2](https://ctfsimulation.herokuapp.com)) to explore CTF function!
